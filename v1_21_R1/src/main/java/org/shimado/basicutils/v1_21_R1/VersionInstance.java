...
public class VersionInstance implements IVersionControl {
    ...
    public void createFirework(Player player, Location loc, ItemStack fireworkItem) {
        ...
        NMSUtil.sendPacket(player, new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(firework), firework.cz(), loc.getX(), loc.getY(), loc.getZ(), firework.dG(), firework.dE(), firework.am(), 1, firework.dr(), firework.ct() * 1.0));
        firework.f = 0;
