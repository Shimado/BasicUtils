...
public class VersionInstance implements IVersionControl {
    ...
    public void createFirework(List<Player> players, Location loc, ItemStack fireworkItem) {
        ...
        Packet spawnPacket = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(firework), firework.cG(), loc.getX(), loc.getY(), loc.getZ(), firework.dL(), firework.dN(), firework.an(), 1, firework.dy(), firework.cA() * 1.0);
    ...
    public Pair spawnArmorStandByLocation(Location loc, org.bukkit.inventory.ItemStack itemHead, boolean isSmall, float angleX, float angleY, float angleZ){
        ...
        Packet packet = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(stand), stand.cG(), stand.dA(), stand.dC(), stand.dG(), stand.dL(), stand.dN(), stand.an(), 1, stand.dy(), (double) stand.cA());
        ...
        try {
            ...
            Field invis = Entity.class.getDeclaredField("am");
    ...
    public void spawnArmorStandToPlayer(Player player, Object standRaw, org.bukkit.inventory.ItemStack itemHead, Object packetRaw){
        ...
        Packet packetSpawn = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(stand), stand.cG(), stand.dA(), stand.dC(), stand.dG(), stand.dL(), stand.dN(), stand.an(), 1, stand.dy(), (double) stand.cA());
    ...
    public Object createItem(List<Player> players, Location loc, ItemStack itemToDrop, double vectorX, double vectorY, double vectorZ) {
        ...
        Packet spawnPacket = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(item), item.cG(), loc.getX(), loc.getY(), loc.getZ(), item.dL(), item.dN(), item.an(), 1, item.dy(), item.cA());
