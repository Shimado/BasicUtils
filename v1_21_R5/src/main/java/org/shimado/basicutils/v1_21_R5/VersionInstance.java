...
public class VersionInstance implements IVersionControl {
    ...
    public void createFirework(List<Player> players, Location loc, ItemStack fireworkItem) {
        ...
        Packet spawnPacket = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(firework), firework.cK(), loc.getX(), loc.getY(), loc.getZ(), firework.dP(), firework.dR(), firework.ap(), 1, firework.dA(), firework.cE() * 1.0);
