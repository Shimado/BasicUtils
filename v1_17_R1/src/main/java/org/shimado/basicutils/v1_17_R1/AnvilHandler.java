package org.shimado.basicutils.v1_17_R1;
...
public class AnvilHandler implements IAnvilHandler {
    ...
    public Inventory openAnvil(Player player, String anvilTitle){
        ...
        entityPlayer.b.sendPacket(packetPlayOutOpenWindow);

        ContainerAnvil anvilContainer = new ContainerAnvil(id, entityPlayer.getInventory());
        anvilContainer.setTitle(IChatBaseComponent.a(ColorUtil.getColor(anvilTitle)));
        anvilContainer.maximumRepairCost = 0;
        entityPlayer.bV = anvilContainer;
