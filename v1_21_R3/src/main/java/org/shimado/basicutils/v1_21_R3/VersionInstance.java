...
public class VersionInstance implements IVersionControl {
    ...
    public void spawnParticleNote(World world, double x, double y, double z, float color) {
        Packet packet = new PacketPlayOutWorldParticles(Particles.ac, false, true, x, y, z, color, 0f, 0f, 1, 0);
    ...
    public Pair spawnArmorStandByLocation(Location loc, org.bukkit.inventory.ItemStack itemHead, boolean isSmall, float angleX, float angleY, float angleZ){
        ...
        Packet packet = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(stand), stand.cG(), stand.dA(), stand.dC(), stand.dG(), stand.dL(), stand.dN(), stand.aq(), 1, stand.dy(), (double) stand.cA());
    ...
    public void spawnArmorStandToPlayer(Player player, Object standRaw, org.bukkit.inventory.ItemStack itemHead, Object packetRaw){
        ...
        Packet packetSpawn = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(stand), stand.cG(), stand.dA(), stand.dC(), stand.dG(), stand.dL(), stand.dN(), stand.aq(), 1, stand.dy(), (double) stand.cA());
    ...
    public Object createItem(List<Player> players, Location loc, ItemStack itemToDrop, double vectorX, double vectorY, double vectorZ) {
        ...
        Packet spawnPacket = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(item), item.cG(), loc.getX(), loc.getY(), loc.getZ(), item.dL(), item.dN(), item.aq(), 1, item.dy(), item.cA());
