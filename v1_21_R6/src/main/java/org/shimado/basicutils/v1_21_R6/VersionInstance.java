package org.shimado.basicutils.v1_21_R6;
...
public class VersionInstance implements IVersionControl {
    ...
    public void createFirework(Player player, Location loc, ItemStack fireworkItem) {
        ...
        NMSUtil.sendPacket(player, new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(firework), firework.cT(), loc.getX(), loc.getY(), loc.getZ(), firework.dX(), firework.dZ(), firework.ax(), 1, firework.dI(), firework.cN() * 1.0));
        firework.i = 0;
        NMSUtil.sendPacket(player, new PacketPlayOutEntityMetadata(NMSUtil.getEntityID(firework), firework.aC().b()));
    ...
    public void spawnParticleNote(World world, double x, double y, double z, float color) {
        Packet packet = new PacketPlayOutWorldParticles(Particles.ae, false, true, x, y, z, color, 0f, 0f, 1, 0);
    ...
    public Pair spawnArmorStandByLocation(Location loc, ItemStack itemHead, boolean isSmall, float angleX, float angleY, float angleZ){
        ...
        Packet packet = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(stand), stand.cT(), stand.dK(), stand.dM(), stand.dQ(), stand.dX(), stand.dZ(), stand.ax(), 1, stand.dI(), (double) stand.cN());
    ...
    public void spawnArmorStandToPlayer(Player player, Object standRaw, ItemStack itemHead, Object packetRaw){
        ...
        Packet packetSpawn = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(stand), stand.cT(), stand.dK(), stand.dM(), stand.dQ(), stand.dX(), stand.dZ(), stand.ax(), 1, stand.dI(), (double) stand.cN());
    ...
    public Object createItem(List<Player> players, Location loc, ItemStack itemToDrop, double vectorX, double vectorY, double vectorZ) {
        ...
        Packet spawnPacket = new PacketPlayOutSpawnEntity(NMSUtil.getEntityID(item), item.cT(), loc.getX(), loc.getY(), loc.getZ(), item.dX(), item.dZ(), item.ax(), 1, item.dI(), item.cN());
