package org.shimado.basicutils.v1_20_R1;
...
public class VersionInstance implements IVersionControl {
    ...
    public void createFirework(Player player, Location loc, ItemStack fireworkItem) {
        ...
        firework.f = 0;
        NMSUtil.sendPacket(player, new PacketPlayOutEntityMetadata(NMSUtil.getEntityID(firework), firework.aj().b()));
    ...
    public void spawnParticleNote(World world, double x, double y, double z, float color) {
        Packet packet = new PacketPlayOutWorldParticles(Particles.V, false, x, y, z, color, 0f, 0f, 1, 0);
